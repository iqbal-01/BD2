...
function getSortedHTL(hotels1, hotels2) {
  return hotels1.price - hotels2.price;
}
function getSortedLTH(hotels1, hotels2) {
...
app.get('/hotels/sort/pricing', (req, res) => {
  ...
  if (sortType === 'low-to-high') {
    sortedHotels.sort(getSortedHTL);
  }
...
function getSortedHTLRating(hotels1, hotels2) {
  return hotels1.rating - hotels2.rating;
}
function getSortedLTHRating(hotels1, hotels2) {
...
app.get('/hotels/sort/rating', (req, res) => {
  ...
  let sortedHotels = hotels.slice();
  if (sortType === 'low-to-high') {
    sortedHotels.sort(getSortedHTLRating);
  }
  if (sortType === 'high-to-low') {
...
function getSortedHTLReview(hotels1, hotels2) {
  return hotels1.reviews - hotels2.reviews;
}
function getSortedLTHReview(hotels1, hotels2) {
...
// Parking
// Free WiFi
function filterByAmenity(hotel, filterType) {
  return hotel.amenity.toLowerCase() === filterType.toLowerCase();
}
...
function filterByCountry(hotel, filterType) {
  return hotel.country.toLowerCase() === filterType.toLowerCase();
}
...
function filterByCategory(hotel, filterType) {
  return hotel.category.toLowerCase() === filterType.toLowerCase();
}
